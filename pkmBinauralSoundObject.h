...
#ifndef pkmBinauralSoundObject_
#define pkmBinauralSoundObject_
...
class pkmBinauralSoundObject
{
	
public:
	pkmBinauralSoundObject();
	~pkmBinauralSoundObject();
	...
	// just for reference, not worth using
...
private:
	...
	static size_t					fftSize, 
                                    ...
                                    bufferSize, 
                                    paddedBufferSize;
	static COMPLEX_SPLIT			signal_fft, 
	...
	bool							bThisObjInitialized, bNoFilter;
